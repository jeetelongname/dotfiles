-- this is my config of Awesome. it is based on the one found at wwww.gitlab.com/dw1 
...
-- Enable a bunch of widgets and things
...
globalkeys = my_table.join(
    ...
    -- My applications (Super+Alt+Key)
       ...
       -- programs
    --awful.key({modkey,    }, "d" ,function () spotify_shell.launch() end,{description = "to control spotify using commands", group = "programs"})

    awful.key({modkey, }, "d", function () spotify_shell.launch()  end,
        {description = "spotify commands" , group = "programs"}),

   awful.key({ }, "Print", function () awful.util.spawn("deepin-screenshot") end,
        {description = "Deepin-screenshot", group = "screenshots"}),
   ...
   awful.key({modkey, }, "f", function () awful.util.spawn("nemo ") end,
        {description = "Nemo File Manager" , group = "programs"}),

  awful.key({modkey, }, "r", function () awful.util.spawn("rofi -show run") end,
         {description = "Run launcher" , group = "programs"}),

 awful.key({modkey, },"i", function () awful.util.spawn("firefox") end,
         {description = "run web browser" , group = "programs"}),

 awful.key({modkey, }, "e", function () awful.util.spawn("emacs") end,
         {description = "opens up emacs" , group = "programs"}),
...
--        {description = "view previous", group = "tag"}),
    ...
    -- Brightness
    awful.key({modkey, }, "y", function () os.execute("xbacklight -inc 10") end,
              {description = "+10%", group = "hotkeys"}),
    awful.key({modkey, }, "u", function () os.execute("xbacklight -dec 10") end,
              {description = "-10%", group = "hotkeys"}),
