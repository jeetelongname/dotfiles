...
*** comment macro
I really like the clojure ~comment~ macro that takes in a list of forms and always
returns nil. it makes interactive use really easy. it does not evaluate
anything.
...
** checkers
*** COMMENT syntax
this is now a module doomemacs/doomemacs#6660, This is now merged
...
[[edraw:data=]]
[[file:diagrams.svg]]
...
#+END_SRC
*** corfu :corfu:
Also deals with completions, something else I like.
#+begin_src emacs-lisp
...
[[https://github.com/intel/intel-one-mono/][Intel One Mono is now my new best friend]]
...
#+RESULTS:
| doom--setq-evil-normal-state-cursor-for-+doom-dashboard-mode-h |
...
#+end_src
*** Popup
We make the results output because otherwise when my butter fingers hits [[kbd:RET]]
the output explodes
...
This less hot little number asks for confirmation before restoring workspaces
#+begin_src emacs-lisp
...
**** TODO Capture
switch to doct, steal [[https://tecosaur.github.io/emacs-config/#visuals][tecos config on the matter]]
#+begin_src emacs-lisp :tangle packages.el
(package! doct)
#+end_src
#+BEGIN_SRC emacs-lisp
...
Lsp schenanigans, just about works but I am not sure how to get the methods to
actually work.
#+begin_src emacs-lisp
...
#+end_src
*** rss :rss:
Elfeed i    s great. I just need more blogs
