;;; doom-horizon-light-theme.el --- Inspired by VSCode Horizon Light -*- no-byte-compile: t; -*-

;;; Commentary:
;;; This theme was inspired by the port of Horizon-Light to Emacs
...
(defcustom doom-horizon-light-comment-bg doom-horizon-brighter-comments
...
(def-doom-theme doom-horizon-light
  "A port of the port of the Visual Studio Code theme Horizon-Light"
  ...
  ;; name        default   256       16
  ( (bg         '("#fadad1" "#FADAD1" nil            ))
    (bg-alt     '("#FADAD1" "#FADAD1" nil            ))
    (base0      '("#16161C" "#16161C" "black"        ))
    (base1      '("#1A1C23" "#1A1C23" "brightblack"  ))
    (base2      '("#1d1f27" "#1d1f27" "brightblack"  ))
    (base3      '("#1d1f27" "#1d1f27" "brightblack"  ))
    (base4      '("#F9CEC3" "#F9CEC3" "brightblack"  ))
    (base5      '("#6a6a6a" "#6a6a6a" "brightblack"  ))
    (base6      '("#2E303E" "#2E303E" "brightblack"  ))
    (base7      '("#232530" "#232530" "brightblack"  ))
    (base8      '("#1C1E26" "#1C1E26" "white"        ))
    (fg-alt     '("#1c1e26" "#1c1e26" "brightwhite"  ))
    (fg         '("#16161C" "#16161C" "white"        ))

    (grey       base4)
    (red        '("#da103f" "#da103f" "red"          ))
    (orange     '("#dc3318" "#dc3318" "brightred"    ))
    (green      '("#07da8c" "#07da8c" "green"        ))
    (teal       '("#1eaeae" "#1eaeae" "brightgreen"  ))
    (yellow     '("#f6661e" "#f6661e" "yellow"       ))
    (blue       '("#1eaeae" "#1eaeae" "brightblue"   ))
    (dark-blue  '("#1d8991" "#1d8991" "blue"         ))
    (magenta    '("#f9cec3" "#f9cec3" "magenta"      ))
    (violet     '("#8931b9" "#8931b9" "brightmagenta"))
    (cyan       '("#6BE6E6" "#6BE6E6" "brightcyan"   ))
    (dark-cyan  '("#27d796" "#27d796" "cyan"   ))

    ;; additional highlighting colours for horizon-light
    (hor-highlight  (doom-lighten base5 0.05))
    (hor-highlight-selected (doom-lighten base5 0.1))
    (hor-highlight-bright (doom-lighten base5 0.2))
    ...
    (-modeline-pad
      (when doom-horizon-light-padded-modeline
        (if (integerp doom-horizon-light-padded-modeline) doom-horizon-padded-modeline 4)))
