...
o-onwy wowks on an e-expwicit sewection a-at the moment
...
(after! (pdf-tools doom-modeline)
  ...
  #+RESULTS:
  | doom-set-pdf-modeline-h | doom--setq-evil-normal-state-cursor-for-pdf-view-mode-h | pdf-tools-enable-minor-modes | doom-modeline-set-pdf-modeline |
